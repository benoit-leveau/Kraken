...
class Builder(Builder):
    ...
    def __init__(self):
        ...
        ks.loadCoreClient()
        ks.loadExtension('KrakenRig')

    def buildItem(self, kSceneItem, typeName, buildName=None):
        ...
        dccSceneItem = ks.constructRTVal(typeName)
        if buildName is not None:
            dccSceneItem.setName(buildName)
    ...
    def buildContainer(self, kSceneItem, buildName):
        ...
        return self.buildItem(kSceneItem, "Container", buildName)
    ...
    def buildLayer(self, kSceneItem, buildName):
        ...
        return self.buildItem(kSceneItem, "Layer", buildName)
    ...
    def buildHierarchyGroup(self, kSceneItem, buildName):
        ...
        return self.buildItem(kSceneItem, "HierarchyGroup", buildName)
    ...
    def buildComponent(self, kSceneItem, buildName):
        ...
        return self.buildItem(kSceneItem, "Component", buildName)
    ...
    def buildSrtBuffer(self, kSceneItem, buildName):
        ...
        return self.buildItem(kSceneItem, "SrtBuffer", buildName)
    ...
    def buildJoint(self, kSceneItem, buildName):
        ...
        return self.buildItem(kSceneItem, "Joint", buildName)
    ...
    def buildLocator(self, kSceneItem, buildName):
        ...
        return self.buildItem(kSceneItem, "Locator", buildName)
    ...
    def buildCurve(self, kSceneItem, buildName):
        ...
        dccSceneItem = self.buildItem(kSceneItem, "Locator", buildName)
    ...
    def buildControl(self, kSceneItem, buildName):
        ...
        dccSceneItem = self.buildItem(kSceneItem, "Control", buildName)
    ...
    def buildBoolAttribute(self, kAttribute):
        ...
        dccSceneItem = self.buildItem(kSceneItem, "BoolAttribute", kAttribute.getName())
        dccSceneItem.setValue("", kAttribute.getValue())
    ...
    def buildFloatAttribute(self, kAttribute):
        ...
        dccSceneItem = self.buildItem(kSceneItem, "FloatAttribute", kAttribute.getName())
        dccSceneItem.setValue("", kAttribute.getValue())
    ...
    def buildIntegerAttribute(self, kAttribute):
        ...
        dccSceneItem = self.buildItem(kSceneItem, "IntegerAttribute", kAttribute.getName())
        dccSceneItem.setValue("", kAttribute.getValue())
    ...
    def buildStringAttribute(self, kAttribute):
        ...
        dccSceneItem = self.buildItem(kSceneItem, "StringAttribute", kAttribute.getName())
        dccSceneItem.setValue("", kAttribute.getValue())
    ...
    def buildAttributeGroup(self, kAttributeGroup):
        ...
        dccSceneItem = self.buildItem(kSceneItem, "AttributeGroup", groupName)
    ...
    def buildPoseConstraint(self, kConstraint):
        ...
        dccSceneItem = self.buildItem(kSceneItem, "PoseConstraintSolver")
